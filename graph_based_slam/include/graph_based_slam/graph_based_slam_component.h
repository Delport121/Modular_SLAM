...
namespace graphslam
{
  ...
  public:
    ...
    lidarslam_msgs::msg::SubMap map_submap_msg_;
    rclcpp::Subscription < lidarslam_msgs::msg::SubMap > ::SharedPtr map_submap_sub_;
    int submap_id_ {0};
    bool initial_submap_received_ {false};
    lidarslam_msgs::msg::MapArray map_array2_msg_;
    double previous_submap_distance_ {0.0};
    std::string node_spacing_method_ {"F"}; // F - frame D - distance
    double distance_for_keyframe_ {1.0};
    ...
    rclcpp::Publisher < visualization_msgs::msg::MarkerArray > ::SharedPtr loop_edges_pub_;
    ...
    // Loop closure method configuration
    bool use_scancontext_ {false};
    bool use_geometric_verification_ {true};

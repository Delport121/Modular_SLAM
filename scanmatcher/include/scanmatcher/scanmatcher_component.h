...
private:
    ...
    rclcpp::Publisher < lidarslam_msgs::msg::SubMap > ::SharedPtr map_submap_pub_;
    ...
    int lru_horizon_ {100};
    int lru_clear_cycle_ {10};
    int voxel_search_offsets_ {1};

    
    // Scan-to-model pipeline variables
    std::shared_ptr<small_gicp::GaussianVoxelMap> voxel_map_;
    ...
    Eigen::Vector3d previous_submap_position_;
    double trans_submap_;
    double submap_distance_ {0};
